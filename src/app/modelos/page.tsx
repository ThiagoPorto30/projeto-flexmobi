...
export default function ModelsPage() {
  return <main className={styles.page}>
    <header className={styles.header}><Link className="brand" href="/" aria-label="flexmobi.rj — início"><span className="brand-mark">f</span><span className="brand-name">flexmobi</span><span className="brand-suffix">.rj</span></Link><nav aria-label="Navegação do catálogo"><Link href="/">Início</Link><Link href="/#lojas">Lojas</Link><Link href="/#test-ride">Agendar test ride</Link></nav></header>
